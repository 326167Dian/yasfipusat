...
?>
            ...
            <div class="box box-primary box-solid">
                ...
                <div class="box-body">
                    ...
                    <form method="POST" action="?module=lapstokopname&act=laporanbulanan" enctype="multipart/form-data" class="form-horizontal">
...
<?PHP
        ...
        case "sinkron_min":
            ...
            header('location:../../media_admin.php?module=lapstokopname');
            break;
        case "sinkron_plus":
            $tgl_awal = $_GET['tgl_awal'];
            $tgl_akhir = $_GET['tgl_akhir'];
