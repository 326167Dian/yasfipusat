...
//HEADER 1
$pdf->Line(0, 2.6, 8, 2.6); //horisontal bawah

$pdf->Line(0, 4.6, 8, 4.6); //judul tabel atas
...
while ($r2 = mysqli_fetch_array($query)) {
	...
	$pdf->Cell(3, 0.4, $r2['nmbrg_dtrkasir'], 0, 1, 'L');
	$pdf->Cell(2, 0.4, $r2['qty_dtrkasir'], 0, 0, 'R');
	$pdf->Cell(2.6, 0.4, $r2['sat_dtrkasir'], 0, 0, 'C');
	$pdf->Cell(1.5, 0.4, format_rupiah($r2['hrgjual_dtrkasir']), 0, 0, 'R');
	$pdf->Cell(1.7, 0.4, format_rupiah($r2['hrgttl_dtrkasir']), 0, 1, 'R');
...
$pdf->Cell(2, 0.4, $r1['nm_carabayar'], 0, 0, 'L');
$pdf->SetX(0.4);
$pdf->Cell(5.3, 0.4, 'Diskon (%) : ', 0, 0, 'R');
$pdf->Cell(1.6, 0.4, $disc, 0, 1, 'R');
$pdf->SetX(0.4);
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(5.3, 0.4, 'Tagihan : ', 0, 0, 'R');
$pdf->Cell(1.6, 0.4, $tagihan, 0, 1, 'R');
$pdf->SetX(0.4);
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(5.3, 0.4, 'Uang Cash : ', 0, 0, 'R');
