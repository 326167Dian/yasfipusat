...
try {
	$ambildata = run_query_or_fail_hapusdetail_trkasir($conn, "SELECT * FROM dropping_detail WHERE id_dtrkasir='$id_dtrkasir'");
	...
	run_query_or_fail_hapusdetail_trkasir($conn, "DELETE FROM dropping_detail WHERE id_dtrkasir = '$id_dtrkasir'");
