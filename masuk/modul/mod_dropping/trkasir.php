            ...
            <div class="box box-primary box-solid table-responsive">
                ...
                <div class="box-body table-responsive">
                    ...
                    if ($status == 'ON') {
                       ...
                       echo '
<div class="marquee">
  <h4><b>Total Komisi Transaksi '.$petugas.' Saat Ini = Rp '.format_rupiah($komisipetugas).'</b></h4>
</div>
...
';
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        $tgl_awal = date('Y-m-d');      
                            ...
                            $ttlmutasi = "SELECT trkasir.id_trkasir, trkasir.kd_trkasir, SUM(trkasir.ttl_trkasir)as ttlskrg1                                       FROM trkasir 
                                        JOIN trdropping ON trkasir.kd_trkasir = trdropping.kd_trkasir 
                            ...
                            $querymutasi = mysqli_query($GLOBALS["___mysqli_ston"], $ttlmutasi);
                            ...
                            $rmutasi = mysqli_fetch_array($querymutasi);
                            $ttlskrgmutasi = $rmutasi['ttlskrg1'];
                            $ttlskrgmutasi2 = format_rupiah($ttlskrgmutasi);
                        ...
                        <tr>
                            ...
                            <tr>
                                <td colspan='10' style='font-weight:bold;'><h2><center>Total Mutasi Hari ini Rp. $ttlskrgmutasi2  ,-</center></h2>  </td>
                        ...
                        "rowCallback": function(row, data, index) {
                            ...
                            if (s == 1 ) {
                               ...
                               $(row).find('td:eq(3)').css('color', '#ffffff'); 
                                ...
                                $(row).find('td:eq(3)').text('Mutasi'); 
                                $(row).find('td:eq(3)').css('background-color', '#ffd700');
                                $(row).find('td:eq(3)').css('color', '#ffffff');                             
                                // $(row).find('td:eq(10)').text('Mutasi'); 
                             }
...
<script>
    ...
    $(document).on('change', '#id_carabayar', function(e){
        ...
        if(id_carabayar == '4'){
            ...
            $.ajax({
                url: 'modul/mod_trkasir/autocabang.php',
                type: 'post',
            }).success(function(response) {
                let data = $.parseJSON(response);
