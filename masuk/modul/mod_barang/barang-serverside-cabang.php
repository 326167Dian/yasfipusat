...
if ($_GET['action'] == "table_data") {
    ...
    $querycount = $db2->query("SELECT count(id_barang) as jumlah FROM barang");
    ...
    if (empty($_POST['search']['value'])) {
        $query = $db2->query("SELECT id_barang,
                                    kd_barang,
                                    nm_barang,
                                    stok_barang,
                                    sat_barang,
        ...
        $querycount = $db2->query("SELECT count(id_barang) as jumlah 
            FROM barang WHERE kd_barang LIKE '%$search%' 
                        OR nm_barang LIKE '%$search%'
                        OR stok_barang LIKE '%$search%'
                        OR sat_barang LIKE '%$search%'
