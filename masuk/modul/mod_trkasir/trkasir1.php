            ...
            <div class="box box-primary box-solid table-responsive">
                ...
                <div class="box-body table-responsive">
                    ...
                    if($status=='ON') {
                        ...
                        echo "<marquee><h4><b>Total Komisi $petugas Saat Ini = Rp " . format_rupiah($komisipetugas) . "</b></h4></marquee>";
                    }
                    ?>
                    <div></div>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        while ($r = mysqli_fetch_array($tampil_trkasir)) {
                            ...
                            echo "
											...
											<td align=right>$w[nama_shift]</td>
											<td align='center'>";
                            $lupa = $_SESSION['level'];
                            if ($lupa == 'pemilik') {
                            ...
                            <a href='modul/mod_laporan/invoice.php?kd_trkasir=<?php echo $r['kd_trkasir'] ?>' target='_blank' title='INVOICE' class='btn btn-success btn-xs'>INVOICE</a>
                        ...
                        echo "</tbody>
                            <tr>
                                <td colspan='4'><strong>Tunai Rp. $ttltunai2 </strong>  </td>
                                <td colspan='2'><strong> Transfer Rp. $ttltransfer2   ,- </strong></td> 
                                <td colspan='4'><strong> Tempo Rp. $ttltempo2  ,- </strong></td> 
                            </tr>
                            <tr>
                                ...
                                <td colspan='2'><strong>Total shift Siang = Rp. $ttlshifty
                                                            <br> Tunai Rp. $ttlshiftytunai
                                                            <br> Transfer Rp. $ttlshiftytransfer
                                                            <br> Tempo Rp. $ttlshiftytempo </strong></td> 
                                <td colspan='4'><strong>Total shift Malam = Rp. $ttlshifty3
                                ...
                                <td colspan='5'> <h3><strong> Rp. $ttlskrg2  ,- </strong></h3></td> 
                            </tr>
                        </table>";
                        ?>
                </div>
									...
									<label class='col-sm-4 control-label'>Jenis Transaksi</label>        		
									 <div class='col-sm-7'>									    
										    <select name='jns_transaksi' id='jns_transaksi' class='form-control'>
										        ...
										        <option value='3'>Gpos/Retella</option>
										        <option value='4'>Halodoc</option>
