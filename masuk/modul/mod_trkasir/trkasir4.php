						...
						<div class='col-lg-6'>
								...
								<div class='form-group'>
									...
									<label class='col-sm-4 control-label'>Komposisi dan Indikasi</label>        		
										<div class='col-sm-7'>
											<input type=text name='tgl_expired' id='tgl_expired' class='form-control' autocomplete='off'>
											</p>
												<div class='buttons'>
						...
						<div class='col-lg-6'>
								...
								<div class='form-group'>
									...
									<label class='col-sm-4 control-label'>Komposisi & Indikasi</label>        		
										<div class='col-sm-7'>
											<input type=number name='tgl_expired' id='tgl_expired' class='form-control' autocomplete='off'>
											</p>
												<div class='buttons'>
													<button type='button' class='btn btn-success right-block' onclick='simpan_detail();'>SIMPAN DETAIL</button>
												</div>
		...
		<table id="example1" class="table table-condensed table-bordered table-striped table-hover" >
						...
						<thead>
							<tr class="judul-table">
								...
								<th style="vertical-align: middle; background-color: #008000; text-align: left; ">My SIFA <BR>Analysis</th>
						...
						<?php $no=1;
								...
								$Q=($rd[hrgjual_barang]-$rd[hrgsat_barang])/$rd[hrgsat_barang];
								...
								if( $Q <= 0.3){
                                        echo" <td style='background-color:#ff003f;'align='center'><strong>Very Low Profit</strong></td> ";                                                            }
                                    elseif ($Q > 0.3 && $Q <= 1){
                                        echo"  <td style='background-color:#f39c12;' align='center'><strong>Low Profit</strong></td>"; }
                                    elseif ($Q > 1 && $Q <= 2){
                                        echo"  <td style='background-color:#00ff3f;' align='center'><strong>Hi Profit</strong></td>"; }
                                    elseif ($Q > 2 ){
                                        echo"  <td style='background-color:#00bfff;' align='center'><strong>Very Hi Profit</strong></td>"; }
                                    ...
                                    echo"											
											 ...
											 <td align=center>$rd[tgl_expired]</td>
											 <td align=center>
											 ...
											 <button class='btn btn-xs btn-info' id='pilihbarang' 
												 ...
												 data-tgl_expired='$rd[tgl_expired]'
...
<script>
	 ...
	 var kd_barang = $(this).data('kd_barang');
	  ...
	  var stok_barang = $(this).data('stok_barang');
	   ...
	   var hrgjual_barang = $(this).data('hrgjual_barang');
	    var tgl_expired = $(this).data('tgl_expired');
		 var qty_default = "1";
			...
			document.getElementById('tgl_expired').value= tgl_expired ;
			//hilangkan modal
			$(".close").click();
	...
	let tgl_expired = document.getElementById('tgl_expired').value;
		...
		if (e.which == 13) { // e.which == 13 merupakan kode yang mendeteksi ketika anda   // menekan tombol enter di keyboard
			...
			var kd_brg = $("#kd_barang").val();
                $.ajax({
					...
					document.getElementById('tgl_expired').value= datab.tgl_expired ;
