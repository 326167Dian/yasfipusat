		  ...
		  <div class='box box-primary box-solid'>
				...
				<div class='box-body'>
						<form method=POST method=POST action=$aksi?module=setheader&act=update_setheader  enctype='multipart/form-data' class='form-horizontal'>
							  ...
							  <div class='form-group'>
									<label class='col-sm-3 control-label'>Stempel</label>        		
									 <div class='col-sm-6'>
										<input type='file' name='fupload3' class='form-control' value='$r[stempel]' autocomplete='off'>
									 </div> <br>
							  </div>
							  ";
                                      echo "<div class='form-group'><div class='col-sm-12' style='text-align:center;'>";
                                      if (!empty($r['logo'])) {
                                        echo "
                                            <div style='display:inline-block; margin:10px; vertical-align:top;'>
                                            <label>Logo</label>
                                            <img src='images/$r[logo]'
                                                 style='display:block; margin:0 auto; max-width:100px; border:1px solid #ccc;'
                                                 alt='Logo'>
                                            </div>
                                        ";
                                     }
