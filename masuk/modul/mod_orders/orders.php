						...
						<div class='col-lg-6'>
							  ...
							  <div class='form-group'>
									...
									<label class='col-sm-4 control-label'>Tanda Tangan Digital</label>        		
										<div class='col-sm-6'>
											<select name='ttd_digital' id='ttd_digital' class='form-control' >
												<option value='TIDAK'>TIDAK </option>	
												<option value='YA'>YA </option>											
											</select>
										</div>
									<label class='col-sm-4 control-label'>Stempel</label>        		
										<div class='col-sm-6'>
									...
									<label class='col-sm-4 control-label'>Nama Barang</label>        		
										<div class='col-sm-7'>
											<div class='btn-group btn-group-justified' role='group' aria-label='...'>
                                                ...
                                                <div class='btn-group' role='group'>
                                                    <button type='button' class='btn btn-primary' id='btn_enter_nmbrg'>Enter</button>
                                                </div>
                                            </div>
										</div>
							...
							<div class='form-group'>
								...
								<label class='col-sm-4 control-label'>Tanggal</label>
									...
									<label class='col-sm-4 control-label'>Jenis Pesanan</label>        		
										<div class='col-sm-6'>
											<select name='ket_trbmasuk' id='ket_trbmasuk' class='form-control' >
												<option value='$re[ket_trbmasuk]'>$re[ket_trbmasuk]</option>
												<option value='REGULER'>REGULER </option>
												<option value='PREKURSOR'>PREKURSOR </option>
												<option value='OOT'>OOT</option>
												<option value='ALKES'>ALKES</option>
									...
									<label class='col-sm-4 control-label'>Tanda Tangan Digital</label>        		
										<div class='col-sm-6'>
										<select name='ttd_digital' id='ttd_digital' class='form-control' >
											<option value='$re[ttd_digital]'>$re[ttd_digital]</option>
											<option value='TIDAK'>TIDAK </option>
											<option value='YA'>YA </option>											
										</select>
										</div>
									<label class='col-sm-4 control-label'>Stempel</label>        		
										<div class='col-sm-6'>
											<select name='stempel' id='stempel' class='form-control' >
												<option value='$re[stempel]'>$re[stempel]</option>
												<option value='TIDAK'>TIDAK </option>	
												<option value='YA'>YA </option>											
											</select>
											</p>
...
<script>
	...
	$(document).on('click', '#btn_enter_nmbrg', function() {
		var nm_barang = $("#nmbrg_dtrbmasuk").val();
		$.ajax({
			url: 'modul/mod_orders/autonamabarang_enter.php',
			type: 'post',
...
// 		$(".close").click();
	...
	function simpan_transaksi() {
		...
		var ttd_digital = document.getElementById('ttd_digital') ? document.getElementById('ttd_digital').value : '';
		var stempel = document.getElementById('stempel') ? document.getElementById('stempel').value : '';
