...
?>
            ...
            <div class="box box-primary box-solid table-responsive">
                <div class="box-header with-border">
                    <h3 class="box-title">TRANSAKSI BARANG MASUK DARI DISTRIBUTOR</h3>
                ...
                <div class="box-body table-responsive">
                    <form action="modul/mod_trbmasukpbf/ubah_status_lunas.php" method="post">
                        ...
                        <!-- <a class='btn btn-warning btn-flat' href='../CHECKLIST_STOK_OPERATOR.md' target='_blank'>CHECKLIST OPERATOR</a>
                        <a class='btn btn-primary btn-flat' href='../CHECKLIST_UJI_STOK.md' target='_blank'>CHECKLIST TEKNIS</a> -->
	...
	WHERE trbmasuk.id_trbmasuk='$_GET[id]'");
                ...
                <table id="example1" class="table table-condensed table-bordered table-striped table-hover table-responsive">
                    ...
                    <tbody>
                        ...
                        while ($q = mysqli_fetch_array($show)) {
                            ...
                            $no++;
                            $subtotal[] = $q['hrgttl_dtrbmasuk'];
                        }
                        ?>
                    </tbody>

                    <tr>
                        <td align='center' colspan='5'><strong>TOTAL Rp. <?= format_rupiah(array_sum($subtotal))  ?> </strong> </td>
        ...
        case "tampiljatuhtempo":
            ...
            $jatuh = $db->query("select jatuhtempo,nm_supplier,id_supplier, sum(ttl_trbmasuk) as hutang from trbmasuk where carabayar !='LUNAS' and jatuhtempo between '$tgl_awal' and '$tgl_akhir' 
        ...
        case "detailhutang":
            ...
            $jatuh = $db->query("select * from trbmasuk where id_supplier='$id_supplier' and carabayar !='LUNAS' and jatuhtempo between '$tgl_awal' and '$tgl_akhir' 
        ...
        case "tampil_distributor":
            ...
            $list = $db->query("select sum(ttl_trbmasuk) as total,trbmasuk.id_supplier,trbmasuk.nm_supplier from trbmasuk join supplier 
                                        on(trbmasuk.id_supplier=supplier.id_supplier) 
                                        where trbmasuk.tgl_trbmasuk between '$tgl_awal' and '$tgl_akhir' group by trbmasuk.id_supplier order by total desc ");
                        ...
                        <table id="example2" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                while ($te = $list->fetch_array()) {
                                    $totbel = $db->query("select sum(ttl_trbmasuk) as tepo, kd_trbmasuk from trbmasuk where id_supplier='$te[id_supplier]' and tgl_trbmasuk between '$tgl_awal' and '$tgl_akhir' ");
        ...
        case "detail":
            ...
            $detail = $db->query("select * from trbmasuk where id_supplier=$supplier and tgl_trbmasuk between '$tgl_awal' and '$tgl_akhir' ");
