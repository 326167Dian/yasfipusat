...
if ($_GET['action'] == "table_data") {
    ...
    $db->query("DROP TEMPORARY TABLE IF EXISTS tmp_brgslow_stats");
    $db->query("CREATE TEMPORARY TABLE tmp_brgslow_stats (
            id_barang INT NOT NULL,
            t30 INT NOT NULL,
            q30 DOUBLE NOT NULL,
            om30 DOUBLE NOT NULL,
            INDEX idx_tmp_brgslow_id (id_barang)
        ) ENGINE=MEMORY");

    $db->query("INSERT INTO tmp_brgslow_stats (id_barang, t30, q30, om30)
        SELECT d.id_barang,
        ...
        HAVING COUNT(d.id_dtrkasir) > 0 AND COUNT(d.id_dtrkasir) < 6");

    $baseFrom = "
        FROM tmp_brgslow_stats x
    ...
    if (!empty($_POST['search']['value'])) {
        ...
        $whereSearch = " WHERE b.kd_barang LIKE '%$search%'
