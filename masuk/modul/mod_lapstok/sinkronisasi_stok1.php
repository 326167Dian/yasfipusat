...
$tampil_barang = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM barang WHERE id_barang <= 3000 ORDER BY barang.id_barang ");
$no=1;
...
while ($r=mysqli_fetch_array($tampil_barang)) {
    ...
    {
        mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE barang SET stok_barang = '$selisih' where kd_barang =$r[kd_barang] ");
    }
    else{}
